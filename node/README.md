...
`dockerfile-gen` is a CLI tool and Go package automatically generates a configurable Dockerfile 
...
See the [GitHub Repository](https://github.com/hivepaas/dockerfile-generator#readme) for full runtime documentation. 
