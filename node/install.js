...
async function downloadCli(version, platform) {
  ...
  const response = await fetch(
    `https://github.com/hivepaas/dockerfile-generator/releases/download/v${version}/${platform.bin}${ext}`
  );
...
const platforms = [
  {
    os: "darwin",
    arch: "x64",
    bin: "dockerfile-gen-darwin-x86_64",
    exe: "bin/dockerfile-gen",
  },
  {
    os: "darwin",
    arch: "arm64",
    bin: "dockerfile-gen-darwin-arm64",
    exe: "bin/dockerfile-gen",
  },
  {
    os: "linux",
    arch: "x64",
    bin: "dockerfile-gen-linux-x86_64",
    exe: "bin/dockerfile-gen",
  },
  {
    os: "linux",
    arch: "arm64",
    bin: "dockerfile-gen-linux-arm64",
    exe: "bin/dockerfile-gen",
  },
  {
    os: "win32",
    arch: "x64",
    bin: "dockerfile-gen-windows-x86_64",
    exe: "bin/dockerfile-gen",
  },
  {
    os: "win32",
    arch: "arm64",
    bin: "dockerfile-gen-windows-arm64",
    exe: "bin/dockerfile-gen",
  },
];
